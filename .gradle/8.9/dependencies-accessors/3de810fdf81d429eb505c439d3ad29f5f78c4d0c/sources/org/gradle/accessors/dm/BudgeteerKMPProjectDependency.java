...
@NonNullApi
public class BudgeteerKMPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BudgeteerKMPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
